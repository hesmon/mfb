...
\# | Lecture | Reading Assignments | Homeworks  |
 ------------- | -------------------------- | ------------- | ------------- | 
1 |  Lecture 1- Introduction to probability; counting; Birthday paradox; story proof (slides, video) <br> <br> Tutorial 1- Introduction to R, RStudio; Basic plotting functions in R By Sajedeh Bahonar <br> <br>  Lecture 2- probability axioms; inclusion-exclusion principle (slides, video) | **Required:** ITP, Ch. 1 | HW1  | 
