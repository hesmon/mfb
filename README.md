...
Lecture A5- Continuous random variable <br> <br> Introduction to continuous random variable ([video A5-part 1](https://youtu.be/LiWSwo8GJaQ)) <br> Normal distribution ([video A5-part 2](https://youtu.be/Pl__Wvk2N7Q)) <br> Exponential distribution; Poisson process ([Video A5-part 3](https://youtu.be/Ptx_7G_ycD4)) <br> Exponential distribution-continued ([video A5-part 4](https://youtu.be/IkaytoEDtYU)) | **Required:** ITP, Ch. 5 |  
Lecture A6- Moments <br> <br> Summaries of a distribution ([video 6-part 1](https://youtu.be/ovyRva5JwTA)) <br> Moment generating functions ([video A6-part 2](https://youtu.be/XIFVstZUAYM))  | **Required:** ITP, Ch. 6 |  
